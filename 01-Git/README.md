...
![Estados posibles de un documento en Git](./img/estados-posibles.png)

* _Untracked_: Archivos nuevos que se agregan por primera vez al repositorio.
* _Unmodified_: Ya están en el repositorio, sin modificaciones.
* _Modified_: Archivo que ya estaba en el repositorio, con modificaciones.
* _Staged_: Listo para guardarse en mi próxima "foto" (versión del archivo). El próximo paso es el commit.
